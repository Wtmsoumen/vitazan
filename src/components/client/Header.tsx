...
export default function Header() {
    ...
    return (
        <>
                        ...
                        <div className="flex items-center gap-1 sm:gap-2">
                            ...
                            >
                                ...
                                <motion.button
                                    ...
                                    whileHover={{ scale: 1.12, backgroundColor: "#0284C7" }}
                                    whileTap={{ scale: 0.95 }}
                                    className="relative flex w-10 h-10 sm:w-12 sm:h-12 md:w-13 md:h-13 items-center justify-center rounded-full group bg-[#E0F2FE] border border-[#0284C7] shadow-md shadow-[#0284C7]/20 transition-all cursor-pointer"
                                    title="Search (⌘K)"
                                >
                                    <Search className="w-5 h-5 sm:w-6 sm:h-6 text-[#0284C7] group-hover:text-white transition-all duration-500" strokeWidth={2.2} />
                                </motion.button>
                                ...
                                {/* <Link href="#/cart">
                                    <motion.div
                                        ...
                                        whileHover={{ scale: 1.12, backgroundColor: "#E5097F" }}
                                        whileTap={{ scale: 0.95 }}
                                        className="relative flex w-10 h-10 sm:w-12 sm:h-12 md:w-13 md:h-13 items-center justify-center rounded-full group bg-[#FCE7F3] border border-[#E5097F] shadow-md shadow-[#E5097F]/20 transition-all"
                                    >
                                ...
                                <Link href="/login">
                                    <motion.div
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        className="relative flex w-10 h-10 sm:w-12 sm:h-12 md:w-13 md:h-13 items-center justify-center rounded-full group bg-[#EDE9FE] border border-[#7C3AED] shadow-md shadow-[#7C3AED]/20 transition-all"
                                    >
                                        <UserRound className="w-5 h-5 sm:w-6 sm:h-6 text-[#7C3AED] group-hover:text-white transition-all duration-500" strokeWidth={2.2} />
                                    </motion.div>
                                </Link>
                            </motion.div>
                            ...
                            <div className="px-4 sm:px-8 py-4 space-y-1">
                                ...
                                <div className="sm:hidden flex items-center gap-3 pt-3 px-3 border-t border-gray-100 mt-2">
                                    <button
                                        ...
                                        className="flex items-center gap-2 py-2 px-3 rounded-lg bg-[#F0F9FF] transition-colors"
                                    >
                                    ...
                                    <Link href="/login" className="flex items-center gap-2 py-2 px-3 rounded-lg bg-[#F5F3FF] transition-colors" onClick={() => setMobileMenuOpen(false)}>
                                        <UserRound className="w-5 h-5 text-[#7C3AED]" />
                                        <span className="text-[14px] font-medium text-black">Account</span>
                                    </Link>
                                </div>
                            </div>
                        </motion.div>
            ...
            {/* Mac Spotlight Global Search Modal */}
