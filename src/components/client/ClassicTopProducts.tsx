                        ...
                        <Link href="/shop/details" >
                            ...
                            >
                                ...
                                <motion.div
                                    ...
                                    transition={{ duration: 0.6, ease: [0.25, 0.1, 0.25, 1] }}
                                    className={`absolute ${idx === 0 ? 'bottom-15 left-1/2' : idx === 1 ? 'lg:bottom-25.5 bottom-19 left-[55%]' : idx === 2 ? 'lg:bottom-8 bottom-10 left-[52%]' : 'lg:bottom-25 bottom-19 left-1/2'} -translate-x-1/2 w-[80%] h-[50%] sm:h-[55%] z-20`}
                                >
                                    <Image
                                        src={product.product}
                                        alt={product.name}
                                ...
                                <motion.div
                                    ...
                                    transition={{ duration: 0.5, ease: [0.25, 0.1, 0.25, 1] }}
                                    className="absolute bottom-0 p-5 sm:p-7 md:p-10 pt-6 sm:pt-8 md:pt-12 z-20"
                                >
                                    <motion.button
